...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  pentestLoop: 'workflow.md',
  pentestModePolicy: 'workflow.md',
  reconEngineOptions: 'workflow.md',
  pentestRunController: 'workflow.md',
  pentestRuns: 'workflow.md',
  planMode: 'plan.md',
  remoteMachines: 'workspace.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  settingsScope: 'client-side settings namespace accessor — packages/client/ui-settings/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  InstalledSkillsValue: 'skills.md',
  SkillSearchRequest: 'skills.md',
  SkillSearchValue: 'skills.md',
  SkillInstallRequest: 'skills.md',
  SkillInstallValue: 'skills.md',
  SkillRemoveRequest: 'skills.md',
  SkillRemoveValue: 'skills.md',
  SkillSetEnabledRequest: 'skills.md',
  SkillSetEnabledValue: 'skills.md',
  SkillTerminalCloseRequest: 'skills.md',
  SkillTerminalCloseValue: 'skills.md',
  SkillTerminalOpenRequest: 'skills.md',
  SkillTerminalOpenValue: 'skills.md',
  SkillTerminalReadRequest: 'skills.md',
  SkillTerminalReadValue: 'skills.md',
  SkillTerminalWriteRequest: 'skills.md',
  SkillTerminalWriteValue: 'skills.md',
  RemoteMachineIdRequest: 'workspace.md',
  RemoteMachineProbeRequest: 'workspace.md',
  RemoteMachineProbeValue: 'workspace.md',
  RemoteMachineProfile: 'workspace.md',
  RemoteMachineRemoveValue: 'workspace.md',
  RemoteMachinesValue: 'workspace.md',
  RemoteMachineSaveRequest: 'workspace.md',
  RemoteMachineTrustRequest: 'workspace.md',
  RemoteMachineValue: 'workspace.md',
  ...
  CommitPentestEpisodeRequest: '../../packages/pentest/pentest-run/README.md',
  CommittedPentestEpisode: '../../packages/pentest/pentest-run/README.md',
  ControlPentestRunRequest: '../../packages/pentest/pentest-run/README.md',
  ControlPentestTaskRequest: '../../packages/pentest/pentest-run/README.md',
  CreatePentestRunRequest: '../../packages/pentest/pentest-run/README.md',
  CreatePentestTaskRequest: '../../packages/pentest/pentest-run/README.md',
  LeasePentestTaskRequest: '../../packages/pentest/pentest-run/README.md',
  PentestArtifactContent: '../../packages/pentest/pentest-run/README.md',
  ...
  PentestRunSnapshot: '../../packages/pentest/pentest-run/README.md',
  PentestTaskId: '../../packages/pentest/pentest-run/README.md',
  PentestTaskLease: '../../packages/pentest/pentest-run/README.md',
  PentestTaskRecord: '../../packages/pentest/pentest-run/README.md',
  ReplacePentestScopeRequest: '../../packages/pentest/pentest-run/README.md',
  WebFetchProvider: 'web.md',
  WebFetchRequest: 'web.md',
  WebFetchResult: 'web.md',
  WebSearchProvider: 'web.md',
  WebSearchPolicySettings: 'web.md',
