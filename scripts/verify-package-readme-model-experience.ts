...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-web-search-mode': { kind: 'indirect', reason: 'The toggle submits the host /web-search command; dsh-tool-web owns the model-visible prompt policy.' },
