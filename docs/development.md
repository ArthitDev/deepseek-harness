...
| `tsconfig.base.json` | Shared compilerOptions and the source `paths` map inherited by the root and package projects. Vite's native tsconfig resolver uses those mappings in tests. | No |
