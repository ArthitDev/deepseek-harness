...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.input.machine',
    kind: 'single',
    scope: 'session',
    summary: 'Local or saved remote machine target inside the composer tool row.',
    doc: 'Local or saved remote machine target inside the composer tool row.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace RemoteMachineControl',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.input.webSearch',
    kind: 'single',
    scope: 'session',
    summary: 'Per-session always-search control inside the composer tool row.',
    doc: 'Per-session always-search control inside the composer tool row.',
    registerOptions: [],
    ownerProps: [
      '/** Owner share of the named plan and model controls. */\nexport interface InputControlOwnerProps {\n  /** Whether the composer currently refuses interaction. */\n  locked: boolean\n}',
    ],
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation ThemeToggle id \'theme-toggle\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-recon ReconView id \'recon\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-skill SkillManagerSection id \'skills\'',
      'client-ui-workspace RemoteMachinesSection id \'remote-machines\'',
    ],
    replaceRisk: 'none',
