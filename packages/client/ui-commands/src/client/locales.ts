...
export const zh = {
  ...
  'description.webSearch': '要求每次请求都进行网页搜索，或恢复自动判断',
  'token.goal': '目标',
  'token.plan': '计划',
  'token.feedback': '反馈',
  'token.compact': '压缩',
...
export const en = {
  ...
  'description.webSearch': 'Require web search on every request, or return to automatic use',
  'token.goal': 'goal',
  'token.plan': 'plan',
