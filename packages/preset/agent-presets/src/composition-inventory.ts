...
export interface AgentPresetRosterCompositionRow {
  /**
...
export interface AgentPresetRosterComposition {
  /** Stable preset id. */
  readonly id: string
...
function flattenRows(
  ...
  evaluateExpression: DisabledExpressionEvaluator,
  found: AgentPresetRosterCompositionRow[],
): void {
...
export async function fileComposition(
  path: string,
  evaluateExpression: DisabledExpressionEvaluator,
): Promise<{ rows: AgentPresetRosterCompositionRow[] } | { broken: string }> {
  let rows: unknown
  try {
  ...
  const found: AgentPresetRosterCompositionRow[] = []
 ...
 */
export function mountedCompositionRows(tree: EntryTree): AgentPresetRosterCompositionRow[] {
  const found: AgentPresetRosterCompositionRow[] = []
